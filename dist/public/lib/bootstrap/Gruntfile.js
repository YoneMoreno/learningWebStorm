...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      customize: {
        src: ['docs/assets/js/_vendor/less.min.js', 'docs/assets/js/_vendor/jszip.min.js', 'docs/assets/js/_vendor/uglify.min.js', 'docs/assets/js/_vendor/blob.js', 'docs/assets/js/_vendor/filesaver.js', 'docs/assets/js/raw-files.min.js', 'docs/assets/js/_src/customizer.js'],
        dest: 'docs/assets/js/customize.min.js'
      },
      docsJs: {
        src: ['docs/assets/js/_vendor/holder.js', 'docs/assets/js/_vendor/ZeroClipboard.min.js', 'docs/assets/js/_src/application.js'],
    ...
    autoprefixer: {
      options: {
        browsers: ['Android 2.3', 'Android >= 4', 'Chrome >= 20', 'Firefox >= 24', // Firefox 24 is the latest ESR
    ...
    cssmin: {
      ...
      docs: {
        src: ['docs/assets/css/_src/docs.css', 'docs/assets/css/_src/pygments-manni.css'],
    ...
    'saucelabs-qunit': {
      all: {
        options: {
          ...
          concurrency: 10,
          maxRetries: 3,
          urls: ['http://127.0.0.1:3000/js/tests/home.handlebars'],
